...
from wi1_bot.transcoder.ffprobe import ffprobe
from wi1_bot.transcoder.transcoder import Transcoder

# real ffmpeg integration tests; skipped where ffmpeg isn't installed (e.g. CI)
...
def _config(profile: MagicMock) -> MagicMock:
    ...
    config.general.remote_path_mappings = []
    config.worker.tmp_dir = None
    return config
