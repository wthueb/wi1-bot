...
- **Type hints**: Strict mypy typing required (`strict = true`). Always use type annotations.
...
- **Assertions**: Use `assert isinstance()` when working with pyarr API responses to satisfy mypy
